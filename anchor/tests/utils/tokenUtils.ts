...
const initMint = (client: LiteSVM): PublicKey => {
    let mintPubkey: PublicKey = new PublicKey("EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v");
 ...
 */
const getOrCreateATA = async (client: LiteSVM, owner: PublicKey, mintAddress: PublicKey = MINT_ADDRESS): Promise<PublicKey> => {
...
const createAta = (client: LiteSVM, ata: PublicKey, owner: PublicKey, mintAddress: PublicKey = MINT_ADDRESS): PublicKey => {
 ...
 */
const mintAmountTo = (client: LiteSVM, ata: PublicKey, owner: PublicKey, amount: BN, mintAddress: PublicKey = MINT_ADDRESS): PublicKey => {
