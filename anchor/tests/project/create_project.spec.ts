...
import { createProject, createUserWalletWithSol, getPda } from '../utils/testUtils';
...
describe('create_project', () => {
    ...
    describe("success cases", () => {
        it("successfully create a project", async () => {
            ...
            expect(new ProjectStatus(project.status).enum).toEqual(ProjectStatus.WaitingForApproval.enum);
