import { approveProject, createProject, createUserWalletWithSol, getPda, updateAdmins } from '../utils/testUtils';
...
describe('approve_project', () => {
    ...
    describe("success cases", () => {
        it("successfully approve a project", async () => {
            ...
            expect(new ProjectStatus(project.status).enum).toEqual(ProjectStatus.Published.enum);
        });
    });
});
